package com.proyecto.services.data;
...
public class DatabaseJson {
    ...
    public static void saveFile(String newJsonFile) {
    	...
    	try {
    		FileWriter crunchifyWriter = new FileWriter("/Users/pablo/git/repository/ejercicio1/practicas-1-master/exercise2/proyecto-service/src/main/resources/cars-id.json", true);
